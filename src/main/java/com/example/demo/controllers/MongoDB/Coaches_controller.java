...
public class Coaches_controller {
    ...
    @Operation(summary = "READ: Get a coach by ID", tags={"Coach","Admin"})
    ...
    @Operation(summary = "CREATE: Create a new coach", tags={"Admin","Coach","Clarify"})
    ...
    @Operation(summary = "UPDATE: Update FIFA version of a coach by ID", tags={"Admin", "Coach","Clarify"})
    ...
    @Operation(summary = "DELETE: Delete a coach by ID", tags={"Admin","Coach","Clarify"})
    ...
    // DELETE: Delete a coach by ID
    @DeleteMapping("admin/coach/delete/team/{_id}")
    @Operation(summary = "DELETE: Delete a team in a coach by ID", tags={"Admin","Coach","Clarify","Team"})
    public ResponseEntity<Void> deleteTeamCoach(@PathVariable String _id) {
        coachesMservice.deleteTeamCoach(_id);
        return ResponseEntity.noContent().build();
    }
}