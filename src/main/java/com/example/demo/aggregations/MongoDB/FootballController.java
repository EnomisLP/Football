...
public class FootballController {
    ...
    @GetMapping("team/{team}/analytics/improvement/{year1}/{year2}")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get the percentage improvements in terms of attack, defense and midfield of a team, between 2 years", tags={"Team"})
