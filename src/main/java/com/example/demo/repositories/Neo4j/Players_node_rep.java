...
public interface Players_node_rep  extends Neo4jRepository<PlayersNode, String>{
    ...
    Page<PlayersNode> findAllByGenderWithPagination(@Param("gender") String gender, Pageable pageable);
