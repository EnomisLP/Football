...
@Repository
public interface Coaches_node_rep extends Neo4jRepository<CoachesNode,String>{
    ...
    Page<CoachesNode> findAllByGenderWithPagination(@Param("gender") String gender, Pageable pageable);
